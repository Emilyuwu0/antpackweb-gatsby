  ...
  return (
    <div className='homeBioSeccionContainer'>
      <div className='infoWrapper'>
        <Title level='h1' titleClass='title' text={`We are dreamers with a <span className='primary'>hunger</span> for <br/> <span>knowledge</span> and a crazy <span className='primary'>drive</span> for <br/> execution.`} />
