  ...
  const data2 = {
    ...
    section_1: {
      ...
      data: [
        ...
        {
          title: 'TECHNOLOGIES',
          elements: [{ title: 'Wordpress' }, { title: 'MySQL' }],
        },
        {
          title: 'YEAR',
          elements: [{ title: '2020' }],
    ...
    section_3: {
      ...
      title: 'STRATEGY',
      content:
        '<p>Develop the shopping platform in Shopify. Configure real-time reporting for in-site analytics.</p>' +
  ...
  query ($path: String!) {
    markdownRemark(frontmatter: { path: { eq: $path } }) {
      ...
      frontmatter {
        ...
        complementarySectionListItemTwoPartTwo
        complementarySectionListItemThree
        complementarySectionListItemFour
        complementarySectionListItemFourPartTwo
        complementarySectionListItemFourPartThree
